"""
Django settings for Schedule_Demo project.
...
SECRET_KEY = '=l@cxdjy38pfpv90m*nc!%bxh8&*u#8h*uoe1f7le1z_-^v%$n'
...
ROOT_URLCONF = 'Schedule_Demo.urls'
...
WSGI_APPLICATION = 'Schedule_Demo.wsgi.application'
