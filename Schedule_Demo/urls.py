...
urlpatterns = [
    ...
    url(r'^google8927080364559da0.html', TemplateView.as_view(template_name='Demo/google8927080364559da0.html'),
        name='Google authorization verification'),
    url(r'^test', views.test, name='test'),
    url(r'^get-calendar-permission', views.get_calendar_permission, name='get-calendar-permission'),
